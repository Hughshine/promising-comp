...
(** Theorem [sema_eq_ps_nps] in this file (Theorem 4.1 in paper) is the final theorem
    that shows the semantics equivalence between PS2.1 and the non-preemptive semantics. *)

(** Theorem [sema_eq_ps_nps] corresponds to the step 5 in Figure 6 (Our proof path)
    in our paper. *)
