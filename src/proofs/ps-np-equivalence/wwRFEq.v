...
(** Theorem [ww_RF_eq] in this file is the theorem (Lemma 5.1 in our paper) to
    show the equivalence between the write-write race freeodoms
    in the promising semantics and the non-preemptive semantics. *)

(** Theorem [ww_RF_eq] corresponds to the step 1 in Figure 6 (Our proof path) in our paper. *)
