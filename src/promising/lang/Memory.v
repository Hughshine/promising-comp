...
(** This file defines the memory in promising semantics (PS2.1). *)
(** The memory in promising semantics is a message pool defined as (Mem) in Figure 8 in the paper. *)
Module Memory.
  (** ** Memory *)
  (** Memory in promising semantics is defined as a mapping
      from location to a cell. *)
  (** Cell is a mapping from timestamp to the message.
      The message has two types: concrete message and reservation message. *)
