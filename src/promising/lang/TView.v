...
Module TView <: JoinableType.
  (** Thread view includes:
      - [rel]: release view;
      - [cur]: current view;
      - [acq]: acq view.

  In our paper, to simplify the presentation,
  the thread view only contains the current view.

  Release and acquire views are used to model the
  semantics of fence operations. *)
  Structure t_ := mk {
    rel: LocFun.t View.t;
    cur: View.t;
    acq: View.t;
  ...
  Inductive le_ (lhs rhs:t): Prop := (*TODO: what's le? *)
  | le_intro
